...
class Pr006 {	
	public static void main(String args[]) 
	  ...
	  //Клавиатурный ввод символа
		...
		//Угадывание значения переменной символьной	
	/*	char answer = 'D';
		...
		//Многоступенччатая конструкция if-else-if 
		for(i =0; i<6; i++) {
                     if(i == 1)
			    ...
			    //все оставшиеся варианты выведут значения, указаные ниже
		...
		switch(ch2) {
			case 'A':
				  ...
				  switch(ch1) {
					case 'A':
					       	System.out.println("Значение А внутренего оператора switch");
						  break;
				  } 
				  break;
			case 'R':
		      System.out.println("Значение R внешнего оператора switch");
	                      switch(ch1) {	    
				      case 'A':
                                       System.out.println("Значение A внутренего оператора switch");                                                    break;			
			}
			break;
		default:
		...
		//Оператор цикла for
		 ...
		 for(x = 100; x > -100; x -= 5)
			  System.out.println(x);
				  ...
				  System.out.println("\nпример цикла, тело которого не выполнилось ни разу");
		  for(x = 100; x > 100; x -= 5)
			  System.out.println(x);
		  ...
		  for(i=0, j=10; i < j; i++, j--)
			...
			System.out.print("\nВведите \'S\' для цикла чтения с клавиатуры ");
			...
			for (i = 1; i <= 5; sum += i++);
			 ...
			 //Обьявление параметра цикла внутри цикла
