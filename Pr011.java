class Pr011 {
	public static void main(String args[]) {
		...
		int val1 = 1;
		 ...
		 //Оператор ? - используеться вместо конструкции if()....else...
		...
		//Пример использования оператора ? для предотвращения запрещенных арифмитических операции
		//запрещенная арифмитическая операция - деление на ноль: value = 10/0;
		 System.out.println();
		 int result;
		 for(int i = -5; i <6; i++) {
			result = i != 0 ? 100/i : 0; 
