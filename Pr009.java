	...
	for(i =1; i <20; i++) {
	 ...
	 int sample3[] = {10,51,-24,-66,88,12,35,11,15,2,-99};
	   for(i =1; i <= 10; i++)
		...
		//Другая форма обьявления массива
		int[] array = new int[5];
		 ...
		 for(i=0; i<10; i++)
		  ...
		  System.out.print("массив nums2: ");
		   for(i=0; i<10; i++)
		    ...
		    //Присваивание ссылки на массив nums 1

		    nums2 = nums1; //Обе переменные ссылаються на обьект на который ссылалась nums1
		  ...
		  for(i=0; i<10; i++)
		   ...
		   //Использование переменной экземляра length
