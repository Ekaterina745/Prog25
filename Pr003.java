class Pr003 {
    public static void main(String args[])  {
      ...
      for (int i = (int) ch; i < (int) 'А' + 66; i++) { 
       ...
       int_var = 0xFF; //шестнадцитиричный формат числа 
       int int_var2 = 023;//восмеричныйформат симла 
       int int_var3 = 0b00001000;//двоичный формат числа 
       System.out.println("Значения: " + int_var + " " + int_var2 + " " + int_var3);

       //Управляющая последовательности символов
       System.out.println("\nУправляющие последовательности: \n\\\'\tАпостроф\n\\\"\tДвойная кавычка\n\\r\tВозврат коретки");
       System.out.println("\\f\tПеревод страницы\n\\b\tВозврат на одну позицию");
       //Присваевание управляющего символа 
	ch = '\n';
        System.out.println("первоя строка" + ch + "вторая строка");
